...
doom_one.load_colorscheme = function()
    ...
    local search_high_ui = {
        ...
        Title = { fg = magenta, gui = 'bold' },
        TitleTwo = { fg = violet, gui = 'bold' },
    ...
    if configuration.enable_treesitter then
        ...
        high_link('@markup.link.url', 'Constant')
        high_link('SpecialChar', 'Operator')
        high_link('@text.literal.block', 'CommentNoItalics')
        high_link('@markup.heading.1.markdown', 'Title')
        high_link('@markup.heading.2.markdown', 'TitleTwo')
        high_link('@markup.heading.3.markdown', 'TitleTwo')
        high_link('@markup.heading.4.markdown', 'TitleTwo')
        high_link('@markup.raw.block.markdown', 'Title')
        high_link('@markup.raw.block.markdown', 'Block')
        high_link('@markup.raw.markdown_inline', 'Constant')
